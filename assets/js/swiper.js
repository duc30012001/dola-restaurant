!(function (e, t) {
  ...
  var g,
    ...
    C = {
      ...
      on: function () {
        ...
        "function" == typeof t[1] && ((a = t[0]), (s = t[1]), (n = t[2]), (r = void 0)),
          n || (n = !1);
          ...
          for (var d = o[l], p = 0; p < this.length; p += 1) {
            ...
            if (
              ...
              for (var v = c.length - 1; v >= 0; v -= 1) {
                var f = c[v];
                (s && f.listener === s) ||
                (s && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === s)
                  ? (u.removeEventListener(d, f.proxyListener, n), c.splice(v, 1))
                  : s || (u.removeEventListener(d, f.proxyListener, n), c.splice(v, 1));
              }
          }
        return this;
      },
      trigger: function () {
        for (var e = o(), t = arguments.length, i = new Array(t), a = 0; a < t; a++)
          i[a] = arguments[a];
    ...
    return (
      s.WebKitCSSMatrix
        ...
        : (i = (r =
            ...
            .split(",")),
      "x" === t &&
        (a = s.WebKitCSSMatrix ? r.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
      "y" === t &&
        (a = s.WebKitCSSMatrix ? r.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
      a || 0
    );
  }
  function x(e) {
        ...
        (b = (function (e) {
          ...
          return (
            !u &&
              ...
              ((u = s.match(/(Version)\/([\d.]+)/)) || (u = [0, 1, "13_0_0"]), (h = !1)),
        ...
        if (!a.isTouchEvent || "touchmove" === l.type) {
          ...
          if (!i.allowTouchMove)
            return (
              ...
              void (
                a.isTouched &&
                (E(n, { startX: p, startY: u, currentX: p, currentY: u }), (a.touchStartTime = T()))
              )
            );
              ...
              if (void 0 === a.isScrolling)
                ...
                (i.isVertical() && n.currentX === n.startX)
                  ...
                  : c * c + v * v >= 25 &&
                    ...
                    (a.isScrolling = i.isHorizontal() ? f > r.touchAngle : 90 - f > r.touchAngle));
              if (
                    ...
                    ? ((g = !1),
                      r.resistance &&
                        (a.currentTranslate =
                          i.minTranslate() -
                          1 +
                          Math.pow(-i.minTranslate() + a.startTranslate + h, b)))
                    : h < 0 &&
                      ...
                      r.resistance &&
                        (a.currentTranslate =
                          i.maxTranslate() +
                          1 -
                          Math.pow(i.maxTranslate() - a.startTranslate - h, b))),
        ...
        if (a.freeMode) {
          ...
          if (a.freeModeMomentum) {
            ...
            if (y < t.maxTranslate())
              ...
              y = -(y =
                Math.abs(l[M] - y) < Math.abs(l[M - 1] - y) || "next" === t.swipeDirection
                  ? l[M]
                  : l[M - 1]);
            }
            if (
  ...
  var F = {
      ...
      update: {
                ...
                if ("row" === a.slidesPerColumnFill && a.slidesPerGroup > 1) {
                  var G = Math.floor(I / (a.slidesPerGroup * a.slidesPerColumn)),
                    ...
                    H =
                      0 === G
                        ? a.slidesPerGroup
                        : Math.min(Math.ceil((u - G * L * a.slidesPerGroup) / L), a.slidesPerGroup);
                  (B = (D = N - ($ = Math.floor(N / H)) * H + G * a.slidesPerGroup) + ($ * S) / L),
                    A.css({
        ...
        updateSlidesProgress: function (e) {
          ...
          if (0 !== a.length) {
            ...
            for (var n = 0; n < a.length; n += 1) {
              var o = a[n],
                l =
                  (s + (i.centeredSlides ? t.minTranslate() : 0) - o.swiperSlideOffset) /
        ...
        updateSlidesClasses: function () {
          ...
          i.removeClass(
            ...
            (e = o
              ? t.$wrapperEl.find("." + a.slideClass + '[data-swiper-slide-index="' + s + '"]')
        ...
        updateActiveIndex: function (e) {
          ...
          if ((t >= s.length && (t = s.length - 1), p !== o)) {
            ...
            E(i, { snapIndex: t, realIndex: v, previousIndex: o, activeIndex: p }),
        ...
        updateClickedSlide: function (e) {
          ...
          (i.clickedSlide = r),
            i.virtual && i.params.virtual.enabled
              ? (i.clickedIndex = parseInt(m(r).attr("data-swiper-slide-index"), 10))
              : (i.clickedIndex = t),
      ...
      translate: {
        ...
        setTranslate: function (e, t) {
          ...
          i.isHorizontal() ? (l = a ? -e : e) : (d = e),
            ...
            r.cssMode
              ? (n[i.isHorizontal() ? "scrollLeft" : "scrollTop"] = i.isHorizontal() ? -l : -d)
              : r.virtualTranslate || s.transform("translate3d(" + l + "px, " + d + "px, 0px)"),
            (i.previousTranslate = i.translate),
            (i.translate = i.isHorizontal() ? l : d);
          var p = i.maxTranslate() - i.minTranslate();
          (0 === p ? 0 : (e - i.minTranslate()) / p) !== o && i.updateProgress(e),
        ...
        translateTo: function (e, t, i, a, r) {
          ...
          if (((l = a && e > d ? d : a && e < p ? p : e), s.updateProgress(l), n.cssMode)) {
            ...
            if (0 === t) o[c ? "scrollLeft" : "scrollTop"] = -l;
              ...
              o.scrollTo((((u = {})[c ? "left" : "top"] = -l), (u.behavior = "smooth"), u));
      ...
      slide: {
        slideTo: function (e, t, i, a, r) {
          ...
          g >= d.length && (g = d.length - 1),
            (c || l.initialSlide || 0) === (u || 0) && i && n.emit("beforeSlideChangeStart");
          var b,
            y = -d[g];
          ...
          if (n.initialized && o !== c) {
            ...
            if (!n.allowSlidePrev && y > n.translate && y > n.maxTranslate() && (c || 0) !== o)
              return !1;
          }
          if (
      ...
      manipulation: {
        ...
        addSlide: function (e, t) {
          var i = this,
            ...
            s = i.activeIndex;
          r.loop &&
            ((s -= i.loopedSlides), i.loopDestroy(), (i.slides = a.children("." + r.slideClass)));
        ...
        removeSlide: function (e) {
          var t = this,
            ...
            r = t.activeIndex;
          i.loop &&
            ((r -= t.loopedSlides), t.loopDestroy(), (t.slides = a.children("." + i.slideClass)));
          var s,
            n = r;
          if ("object" == typeof e && "length" in e) {
    ...
    R = (function () {
      function t() {
        for (var e, i, a = arguments.length, r = new Array(a), s = 0; s < a; s++)
          r[s] = arguments[s];
        if (
          (1 === r.length &&
          r[0].constructor &&
        ...
        (o.__swiper__ = !0),
          ...
          Object.keys(o.modules).forEach(function (e) {
            ...
            if (t.params) {
              ...
              !0 === i[a] && (i[a] = { enabled: !0 }),
                "object" != typeof i[a] || "enabled" in i[a] || (i[a].enabled = !0),
                i[a] || (i[a] = { enabled: !1 });
            }
          });
        var l,
        ...
        (s.slidesPerViewDynamic = function () {
          ...
          if (t.centeredSlides) {
            for (var o, l = i[s].swiperSlideSize, d = s + 1; d < i.length; d += 1)
              i[d] && !o && ((n += 1), (l += i[d].swiperSlideSize) > r && (o = !0));
            for (var p = s - 1; p >= 0; p -= 1)
              i[p] && !o && ((n += 1), (l += i[p].swiperSlideSize) > r && (o = !0));
          } else for (var u = s + 1; u < i.length; u += 1) a[u] - a[s] < r && (n += 1);
          return n;
        }),
        (s.update = function () {
          var e = this;
        ...
        (s.mount = function (e) {
          ...
          return (
            ...
            e && e.shadowRoot && e.shadowRoot.querySelector
              ? ((i = m(e.shadowRoot.querySelector("." + t.params.wrapperClass))).children =
                  function (e) {
                    return a.children(e);
                  })
  ...
  var W = {
      ...
      init: function () {
        ...
        (a.nextEl || a.prevEl) &&
          ...
          E(i.navigation, { $nextEl: e, nextEl: e && e[0], $prevEl: t, prevEl: t && t[0] }),
      ...
      update: function () {
        ...
        if (i.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            ...
            if (
              (i.dynamicBullets &&
                ...
                (d = ((l = o + (Math.min(p.length, i.dynamicMainBullets) - 1)) + o) / 2)),
              p.removeClass(
                i.bulletActiveClass +
                  " " +
                  i.bulletActiveClass +
                ...
                if (e.params.loop)
                  if (c >= p.length - i.dynamicMainBullets) {
                    for (var g = i.dynamicMainBullets; g >= 0; g -= 1)
                      p.eq(p.length - g).addClass(i.bulletActiveClass + "-main");
          ...
          "custom" === i.type && i.renderCustom
            ? (s.html(i.renderCustom(e, a + 1, n)), e.emit("paginationRender", s[0]))
    ...
    Y = {
      ...
      load: function () {
        ...
        else if (o > 1) for (var p = r; p < r + o; p += 1) l(p) && e.lazy.loadInSlide(p);
        ...
        if (t && !t.destroyed) {
          ...
          l
            ...
            : t.lazy.scrollHandlerAttached ||
              ((t.lazy.scrollHandlerAttached = !0), i.on("scroll", t.lazy.checkInViewOnLoad));
        }
      },
    },
    U = {
        ...
        return (
          ...
          (this.interpolate = function (e) {
            return e
              ? ((n = o(this.x, e)),
                (s = n - 1),
                ((e - this.x[s]) * (this.y[n] - this.y[s])) / (this.x[n] - this.x[s]) + this.y[s])
              : 0;
          }),
          this
        );
      ...
      setTranslate: function (e, t) {
        ...
        function o(e) {
          ...
          "slide" === r.params.controller.by &&
            (r.controller.getInterpolateFunction(e), (a = -r.controller.spline.interpolate(-t))),
          ...
          t.setTransition(e, a),
            0 !== e &&
              ...
              t.$wrapperEl.transitionEnd(function () {
                s &&
                  (t.params.loop && "slide" === a.params.controller.by && t.loopFix(),
                  t.transitionEnd());
              }));
        }
        if (Array.isArray(s))
        ...
        return (
          t.swiper instanceof i
            ? ((e.thumbs.swiper = t.swiper),
              ...
              E(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
            : x(t.swiper) &&
          ...
          if (t.realIndex !== i.realIndex || s) {
            ...
            if (i.params.loop) {
              i.slides.eq(l).hasClass(i.params.slideDuplicateClass) &&
                (i.loopFix(), (i._clientLeft = i.$wrapperEl[0].clientLeft), (l = i.activeIndex));
              var d = i.slides
                  .eq(l)
            ...
            s && (n += "next" === o ? r : -1 * r),
              i.visibleSlidesIndexes &&
                ...
                (i.params.centeredSlides
                  ? (n = n > l ? n - Math.floor(a / 2) + 1 : n + Math.floor(a / 2) - 1)
                  : n > l && (n = n - a + 1),
          ...
          if (
            ...
            for (var v = 0; v < u; v += 1)
              i.$wrapperEl
                ...
                .addClass(c);
          else for (var f = 0; f < u; f += 1) i.slides.eq(t.realIndex + f).addClass(c);
        }
      },
    },
    Z = [
      ...
      },
      {
        ...
        create: function () {
          M(this, { controller: t({ control: this.params.controller.control }, U) });
        },
        on: {
          update: function (e) {
